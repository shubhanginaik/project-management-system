...
public class WorkspaceUserController {
  ...
  @PostMapping
  public ResponseEntity<GlobalResponse<WorkspaceUserResponseDTO>> createWorkspaceUser(@Valid @RequestBody WorkspaceUserRequestDTO workspaceUsersDTO) {
    WorkspaceUserResponseDTO workspaceUsersResponseDTO = workspaceUsersService.createWorkspaceUser(workspaceUsersDTO);
  ...
  public ResponseEntity<GlobalResponse<WorkspaceUserResponseDTO>> getWorkspaceUserById(@PathVariable UUID workspaceUserId) {
    WorkspaceUserResponseDTO workspaceUsers = workspaceUsersService.getWorkspaceUserById(workspaceUserId);
    return new ResponseEntity<>(new GlobalResponse<>(HttpStatus.OK.value(), workspaceUsers), HttpStatus.OK);
  }

  @PutMapping("/{workspaceUserId}")
  public ResponseEntity<GlobalResponse<WorkspaceUserResponseDTO>> updateWorkspaceUser(@PathVariable UUID workspaceUserId, @Valid @RequestBody WorkspaceUserRequestDTO workspaceUsersDTO) {
    WorkspaceUserResponseDTO workspaceUsers = workspaceUsersService.updateWorkspaceUser(workspaceUserId, workspaceUsersDTO);
    return new ResponseEntity<>(new GlobalResponse<>(HttpStatus.OK.value(), workspaceUsers), HttpStatus.OK);
  }
